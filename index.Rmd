...
ggplot(peace_process, aes(x = ceasefire_class)) +
  ...
  theme_minimal()
```
This bar graph illustrates the relationship between the respective ceasefire classes and whether or not the purpose of the ceasefire was to advance peace
